      ...
      <div class="card text-center">
        <div class="card-header">
          <ul class="nav nav-pills card-header-pills">
            <li class="nav-item">
              <a class="nav-link active" aria-current="true" href="user_mypackage_unaccalimed.php" >未領取</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="user_mypackage_return.php" style="color:gray" >退件</a>
            </li>
            <li class="nav-item">
              <a class="nav-link " href="user_mypackage_received.php" tabindex="-1" aria-disabled="true" style="color:gray">已領取</a>
            </li>
          </ul>
        </div>
        <div class="card-body">
          ...
          <div class="table-responsive">
            <?php
              $link = @mysqli_connect( 
                ...
                '',  // 密碼
                'nukpost');
                $query="SELECT * FROM data WHERE status = '未領取' AND recipient = '$user_cookie'";;
